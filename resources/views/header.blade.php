  ...
  <div class="header__avatar"></div>
   ...
   <aside class="sidenav">
     ...
     <ul class="sidenav__list" >
       ...
       <a style="text-decoration: none; font-weight:500" href="{{route('newPemohon.view')}}"><li class="sidenav__list-item"><i class="fas fa-user-plus"></i>&nbsp; DATA BARU</li></a>
       <a style="text-decoration: none; font-weight:500" href="{{route('pemohon.display')}}"><li class="sidenav__list-item"><i class="fas fa-clipboard-list"></i>&nbsp; DATA PENDUDUK</li></a>
