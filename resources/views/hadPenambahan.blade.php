    ...
    <table class="table table-border">
        ...
        <tbody>
            <tr>
                ...
                <td>150</td>
                <td><input type="number" name="int_kos_kronik" id="int_kos_kronik" min="0" class="form-control"></td>
                <td><input type="number" name="kos_kronik" id="kos_kronik" class="form-control" readonly></td>
            </tr>
            <tr>
                <td>Cacat Semulajadi</td>
                <td>150</td>
                <td><input type="number" name="int_cacat_semulajadi" id="int_cacat_semulajadi" min="0" class="form-control"></td>
                <td><input type="number" name="cacat_semulajadi" id="cacat_semulajadi" class="form-control" readonly></td>
            </tr>
            <tr>
                <td>Cacat Mendatang</td>
                <td>150</td>
                <td><input type="number" name="int_cacat_mendatang" id="int_cacat_mendatang" min="0" class="form-control"></td>
                <td><input type="number" name="cacat_mendatang" id="cacat_mendatang" class="form-control" readonly></td>
            </tr>
            <tr>
                <td>Ibu/Bapa</td>
                <td>150</td>
                <td><input type="number" name="int_ibu_bapa" id="int_ibu_bapa" min="0" class="form-control"></td>
                <td><input type="number" name="ibu_bapa" id="ibu_bapa" class="form-control" readonly></td>
            </tr>
            <tr>
                <td>Ibu Tinggal</td>
                <td>150</td>
                <td><input type="number" name="int_ibu_tinggal" id="int_ibu_tinggal" min="0" class="form-control"></td>
                <td><input type="number" name="ibu_tinggal" id="ibu_tinggal" class="form-control" readonly></td>
            </tr>
            <tr>
                <td>Keluarga Bermasalah</td>
                <td>150</td>
                <td><input type="number" name="int_masalah_keluarga" id="int_masalah_keluarga" min="0" class="form-control"></td>
                <td><input type="number" name="masalah_keluarga" id="masalah_keluarga" class="form-control" readonly></td>
            </tr>
            <tr>
                <td>Ibu Tunggal</td>
                <td>150</td>
                <td><input type="number" name="int_ibu_tunggal" id="int_ibu_tunggal" min="0" class="form-control"></td>
